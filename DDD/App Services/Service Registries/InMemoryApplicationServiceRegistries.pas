...
begin
  ...
  FApplicationServiceRegistryItems.Add(
    TApplicationServiceRegistryItem.Create(
...
procedure TInMemoryApplicationServiceRegistries.Clear;
begin

  FreeListItems(FApplicationServiceRegistryItems);
...
begin
  ...
  FApplicationServiceRegistryItems := TList.Create;
...
begin
  ...
  FreeListWithItems(FApplicationServiceRegistryItems);
  inherited;

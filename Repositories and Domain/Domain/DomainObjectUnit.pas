  ...
  type
    ...
    TDomainObject = class abstract(TDomainObjectBase, IDomainObject)
      ...
      protected
        ...
        procedure RaiseExceptionIfIdentityIsNotValid(const Value: Variant); virtual;
...
procedure TDomainObject.RaiseExceptionIfIdentityIsNotValid(
  const Value: Variant);
begin
...
begin
  ...
  RaiseExceptionIfIdentityIsNotValid(Identity);

...
{    EHashErrorClass = class of EHashError;} 
    ...
    TObjectHash = class(THash)
      ...
      public
        ...
        constructor Create(const mustFreeItems: Boolean = true);
...
constructor TObjectHash.Create(const mustFreeItems: Boolean);
begin

  inherited Create;

  f_MustFreeItems := mustFreeItems;

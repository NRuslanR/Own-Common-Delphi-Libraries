...
begin
  ...
  case GetDataSetFieldType(Field) of
    ...
    begin
      ...
      Result.RegularExpression := Format(MONEY_TYPE_REG_EXPR_PATTERN, [DecimalSeparator]);
    ...
    begin
      ...
      Result.RegularExpression := Format(FLOAT_TYPE_REG_EXPR_PATTERN, [DecimalSeparator]);
